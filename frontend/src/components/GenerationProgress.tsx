...
type Props = { planner: Status; designer: Status; assessment: Status; reviewer: Status; handoff: string | null; plan: LessonPlan | null; guide: ActivityGuide | null; instrument: Assessment | null };
...
export function GenerationProgress({ planner, designer, assessment, reviewer, handoff, plan, guide, instrument }: Props) {
